...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p>Release: <a class="text-info"><?php echo $item['Date']; ?></a></p>
            <p>Format: <a class="text-info"><?php echo $item['Format']; ?></a></p>
            <p>Stars: <a class="text-info"><?php echo $item['Stars']; ?></a></p>
